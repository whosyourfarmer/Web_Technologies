...
<h2>Here's the XML:</h2>
<code>
<?php echo htmlentities($moviesResults->asXML()); ?>
</code>
<?php endif; ?>
...
<ul>
	...
	<li>Once the user clicks submit, the XML is produced using the <code>SimpleXML class.</code></li>
</ul>
